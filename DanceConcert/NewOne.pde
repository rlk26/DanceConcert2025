...
class NewOne extends Scene {
  ...
  class Particle {
    ...
    void initialize() {
      if (candy1==null) {
        candy1= loadImage("cone.png");
        candy2= loadImage("pent.png");
        candy3= loadImage("pyramid.png");
        candy4= loadImage("prism.png");
        candy5= loadImage("rect.png");
      }
